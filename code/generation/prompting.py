...
def build_discharge_prompt(patient_data: str, retrieved_chunks: list[dict]) -> str:
    ...
    prompt.append(
        ...
        "and frequency (e.g. \"every 12 hours\"), but do not make up information. "
        ...
        "- For lifestyle factors, if the patient is already doing the right thing (e.g. non-smoking, not overweight),"
        "don't acknowledge it. Only give instructions for things that need to be changed or started.\n"
        ...
        "[number] - [E#] - brief clinical justification\n"
        "Example:\n"
