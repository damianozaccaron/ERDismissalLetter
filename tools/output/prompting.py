...
def deepl_translation(text, auth_key = "3e8dba21-6f6c-4f49-9d7f-:fx", glossary = "627f273f-d457-400f-a171-d04b9c13ddf3"):
...
def build_prompt(patient_data: str, retrieved_chunks: list[dict]) -> str:
    ...
    prompt.append(
        ...
        "4. PROGNOSIS\n"
        "   Based on the clinical data and the guideline excerpts, state the "
        "expected clinical course. Connect the patient's specific findings "
        "(e.g. lab values, imaging, scores) to the guideline criteria that "
        "apply. Cite the relevant excerpt(s) using [E#] notation.\n\n"
